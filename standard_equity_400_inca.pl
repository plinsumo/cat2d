...
sub create_new_order {
    ...
    my $output = sprintf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n",
        $CATactionType,                                                                               #1
        $CATerrorROEID,                                                                               #2
        $CATfirmROEID=&create_fore_id($lroms->[3], $lroms->[37], $lroms->[2], $lroms->[51], $CATtype[0]),          #3
        $CATtype[0],                                                                                  #4
        $CATReporterIMID,                                                                             #5
        ...
        $CATtimeInForce=&checkTif($lroms->[5], $lroms->[2]),                                          #23
        $CATtradingSession,                                                                           #24
        $CAThandlingInstructions="", #&setHandlingInstructions($CATtype[0]),   							  #25
...
sub create_order_routed {
    ...
    my $output = sprintf ("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n",
        $CATactionType,                                     				#1
        $CATerrorROEID,                                     				#2
        $CATfirmROEID=&create_fore_id($lroms->[3], $lroms->[37], $lroms->[2], $lroms->[51], $CATtype[2]),        #3
        $CATtype[2],                                        				#4
        $CATReporterIMID,                                   				#5
        ...
        $CATisoInd,                                         				#27
        $CAThandlingInstructions="", #&setHandlingInstructions($CATtype[2]),   	#28
...
sub create_order_modify {
    ...
    my $output = sprintf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n",
        $CATactionType,                                                           #1
        $CATerrorROEID,                                                           #2
        $CATfirmROEID=&create_fore_id($lroms->[3], $lroms->[37], $lroms->[2], $lroms->[51], $CATtype[4]),    #3
        $CATtype[4],                                                              #4
        $CATReporterIMID,                                                         #5
        $CATorderKeyDate=substr(&getOriginalTime($lroms->[37], $lroms->[2]),0,15) . ".000",             #6
        $lroms->[37],                                                             #7
        $CATorderID=&get_symbol($lroms->[13],$lroms->[14] ,$lroms->[50]),         #8
        ...
        $CATtimeInForce=&checkTif($lroms->[5], $lroms->[2]),                      #33
        $CATtradingSession,			                                              #34
        $CATisoInd,                                                               #35
        $CAThandlingInstructions="", #&setHandlingInstructions($CATtype[4]),			  #36
...
sub create_order_cancel {
    ...
    my $output = sprintf("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n",
        $CATactionType,                                             							#1
        $CATerrorROEID,                                             							#2
        $CATfirmROEID=&create_fore_id($lroms->[3], $lroms->[37], $lroms->[2], $lroms->[51], $CATtype[3]),    #3
        $CATtype[3],                                                							#4
        $CATReporterIMID,                                           							#5
        $CATorderKeyDate=substr(&getOriginalTime($lroms->[37], $lroms->[2]),0,15) . ".000",    #6
        $CATorderID=$lroms->[37],                                   							#7
